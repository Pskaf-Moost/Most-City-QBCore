...
Config.Debug = true -- Set to true to show green debug boxes to help track

Config.img = "qb-inventory/html/images/" -- Set this to the directory for your inventory image files

Config.distkph = true -- Set to false to read distance travelled in Miles.
...
Config.CosmeticsJob = true -- Do vehicle cosmetics require a mechanic job role?

Config.FreeRepair = true  -- Are repairs free? True means yes
